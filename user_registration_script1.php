...
$duplicate_user_query="select username from seller where email='$email'";
...
$rows_fetched=mysqli_num_rows($duplicate_user_result);
    if($rows_fetched>0){
        ...
        <meta http-equiv="refresh" content="1;url=signupsel.php" />
        <?php
    }else{
        $user_registration_query="insert into seller(username,password,email,contact,address,city) values ('$name','$password','$email','$contact','$address','$city')";
